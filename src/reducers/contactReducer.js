...
export const contactReducer = (state = initialState, action) => {
    ...
    switch(action.type){
      ...
      case CREATE_CONTACT:
        return {
          // object or array here the data is in object in array
          // the action coming from payload 
          // newly create by "action.payload"
          // rest of default contact not ignored by "...state.contacts"
          ...state, //total initial state bydefault
       ...
       case GET_CONTACT:
        ...
        // == compare and match
         ...
         arr = arr.values(); // array to object
        // to search the contact id wise
         for(let val of arr) {
           arr = val;
         }
         return {
